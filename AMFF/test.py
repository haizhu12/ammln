...
if __name__ == '__main__':
    ...
    parser.add_argument('--query_name', default='./data/sketchy_c100/val/sketch/airplane/n02691156_58-1.jpg', type=str,
                        help='Query image name')
    parser.add_argument('--data_base', default='result/sketchy_c100_resnet50_512_vectors.pth', type=str,
