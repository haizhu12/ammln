...
if __name__ == '__main__':
    ...
    parser.add_argument('--vis_name', default='./data/sketchy_c100/val/sketch/airplane/n02691156_58-1.jpg', type=str,
                        help='Visual image name')
    parser.add_argument('--model_name', default='result/sketchy_c100_resnet50_512_model.pth', type=str,
                        help='Model name')
    ...
    if model_name=="result/sketchy_c100_resnet50_512_model.pth":
        backbone_type="resnet50"
        proj_dim="512"
    size = (224, 224)

    vis_image = Image.open(vis_name).resize(size, resample=Image.BICUBIC)
    model = Model(backbone_type, int(proj_dim),100)
