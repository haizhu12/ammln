...
import datetime
#from ResnetModel import HashingModelapexx
...
def load_data(args):
    ...
    if args.data_name == 'tuberlin':
        ...
        print('not support dataset', args.data_name)
...
def build_model_optm(args):
    ...
    if 'cuda' in device:
        model, optimizer = amp.initialize(model, optimizer, opt_level='O0', enabled=True)
